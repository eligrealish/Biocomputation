...
allGeneStd = [[[0.0 for i in range(1)] for j in range(numberOfGenerations)] for w in range(numberOfRuns)]

allIndivduals = [[[0.0 for i in range(1)] for j in range(numberOfGenerations)] for w in range(numberOfRuns)]
